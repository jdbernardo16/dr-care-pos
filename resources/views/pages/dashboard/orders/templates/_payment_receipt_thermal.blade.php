...
<div class="receipt-type">{{ strtoupper(__('PAYMENT RECEIPT')) }}</div>
<div class="columns">
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>
                ...
                <div class="product-meta">{{ $product->quantity }} &times; {{ $product->unit->name ?? '' }}</div>
            </td>
    ...
    <tbody>
        ...
        <tr>
            <td>{{ $paymentTypes[$payment['identifier']] ?? __('Unknown') }} ({{ __('Current') }})</td>
